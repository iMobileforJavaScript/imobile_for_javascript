...
RCT_REMAP_METHOD(analystBuffer, analystBufferByMapId:(NSString*)mapId layerId:(NSString*)layerId params:(NSDictionary*)params  resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject){
    @try {
