...
extern NSString* const IPORTAL_SERVICE_UPLOADING;
extern NSString* const IPORTAL_SERVICE_UPLOADED;
extern NSString* const IPORTAL_SERVICE_DOWNLOADING;
...
extern NSString * const ILLEGALLYPARK;
