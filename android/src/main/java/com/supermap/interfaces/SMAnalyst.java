...
public class SMAnalyst extends ReactContextBaseJavaModule {
    public static final String REACT_CLASS = "SMAnalyst";
    private static SMAnalyst analyst;
    private static ReactApplicationContext context;

    public SMAnalyst(ReactApplicationContext context) {
        super(context);
