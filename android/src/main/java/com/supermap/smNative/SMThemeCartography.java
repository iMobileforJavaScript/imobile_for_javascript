    ...
    public static Color[] getUniqueColors(String colorType) {
        ...
        switch (colorType) {
            ...
            case "CA_Red Rose":
                ...
                break;
            case "CB_Blue and Yellow":
                colors = new Color[]{
                        new Color(245,255,166),
                        new Color(121,232,208),
                        new Color(255,251,0) };
                break;
            case "CC_Pink and Green":
                colors = new Color[]{
